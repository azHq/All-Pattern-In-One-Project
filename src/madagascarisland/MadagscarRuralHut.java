...
public class MadagscarRuralHut extends FlyHut {
	...
	public void buildShape() {
		...
		//roof
		shapes.add(0,new Polygone(roofColor,new double[]{positionX,positionX+(width*1.4),positionX+width*.7},new double[]{positionY,positionY,positionY-(height*.76)}));
		//base
